...
use memorymap_compiler::build_utils::git_root;
...
use memorymap_compiler_c::{self as backend_c, IdentType, TypeReferences, ident};

fn main() {
    let memmap_path = git_root().join("test_memory_maps");
