...
//!
//! Alternatively, one can make use of `clash_macros::BitVector!` and `clash_macros::bitvector!`
...
pub trait BitVectorSizeCheck {
    ...
    /// ```
    /// # use clash_bindings::bitvector::{BitVector, BitVectorSizeCheck};
    /// trait Marker {
    ///     fn nothing();
    /// }
    ///
    ...
    Self: BitVectorSizeCheck<Inner = [u8; N]>,
{
    ...
    #[inline]
    unsafe fn bv_new_unchecked(val: Self::Inner) -> Self {
        unsafe { BitVector::<M, N>::new_unchecked(val) }
    }
...
mod test {
    ...
    fn bv_us_conv_prim() {
        // Check for n = 8
        let bv = clash_macros::bitvector!(0xab, n = 8);
        let us = clash_macros::unsigned!(0xab, n = 8);
        assert_eq!(bv, us.into(), "US -> BV conversion incorrect");
        assert_eq!(us, bv.into(), "BV -> US conversion incorrect");

        // Check for n = 16
        let bv = clash_macros::bitvector!(0xab_cd, n = 16);
        let us = clash_macros::unsigned!(0xab_cd, n = 16);
        assert_eq!(bv, us.into(), "US -> BV conversion incorrect");
        assert_eq!(us, bv.into(), "BV -> US conversion incorrect");

        // Check for n = 32
        let bv = clash_macros::bitvector!(0xab_cd_ef_01, n = 32);
        let us = clash_macros::unsigned!(0xab_cd_ef_01, n = 32);
        assert_eq!(bv, us.into(), "US -> BV conversion incorrect");
        assert_eq!(us, bv.into(), "BV -> US conversion incorrect");

        // Check for n = 64
        let bv = clash_macros::bitvector!(0xab_cd_ef_01_23_45_67_89, n = 64);
        let us = clash_macros::unsigned!(0xab_cd_ef_01_23_45_67_89, n = 64);
        assert_eq!(bv, us.into(), "US -> BV conversion incorrect");
        assert_eq!(us, bv.into(), "BV -> US conversion incorrect");

        // Check for n = 128
        let bv =
            clash_macros::bitvector!(0xab_cd_ef_01_23_45_67_89_ab_cd_ef_01_23_45_67_89, n = 128);
        let us =
            clash_macros::unsigned!(0xab_cd_ef_01_23_45_67_89_ab_cd_ef_01_23_45_67_89, n = 128);
        assert_eq!(bv, us.into(), "US -> BV conversion incorrect");
        assert_eq!(us, bv.into(), "BV -> US conversion incorrect");
    }
    ...
    fn bv_us_conv_nonprim() {
        ...
        let bv = clash_macros::bitvector!(0xab_cd_ef, n = 24);
        let us = clash_macros::unsigned!(0xab_cd_ef, n = 24);
        assert_eq!(bv, us.into(), "US -> BV conversion incorrect");
        assert_eq!(us, bv.into(), "BV -> US conversion incorrect");

        // Check for n = 25 (non-primitive-sized)
        let bv = clash_macros::bitvector!(0x1_ab_cd_ef, n = 25);
        let us = clash_macros::unsigned!(0x1_ab_cd_ef, n = 25);
        assert_eq!(bv, us.into(), "US -> BV conversion incorrect");
        assert_eq!(us, bv.into(), "BV -> US conversion incorrect");
    }
    ...
    fn bv_sn_conv_prim() {
        // Check for n = 8
        let bv = clash_macros::bitvector!(0xab, n = 8);
        let sn = clash_macros::signed!(0xab, n = 8);
        assert_eq!(bv, sn.into(), "SN -> BV conversion incorrect");
        assert_eq!(sn, bv.into(), "BV -> SN conversion incorrect");

        // Check for n = 16
        let bv = clash_macros::bitvector!(0xab_cd, n = 16);
        let sn = clash_macros::signed!(0xab_cd, n = 16);
        assert_eq!(bv, sn.into(), "SN -> BV conversion incorrect");
        assert_eq!(sn, bv.into(), "BV -> SN conversion incorrect");

        // Check for n = 32
        let bv = clash_macros::bitvector!(0xab_cd_ef_01, n = 32);
        let sn = clash_macros::signed!(0xab_cd_ef_01, n = 32);
        assert_eq!(bv, sn.into(), "SN -> BV conversion incorrect");
        assert_eq!(sn, bv.into(), "BV -> SN conversion incorrect");

        // Check for n = 64
        let bv = clash_macros::bitvector!(0xab_cd_ef_01_23_45_67_89, n = 64);
        let sn = clash_macros::signed!(0xab_cd_ef_01_23_45_67_89, n = 64);
        assert_eq!(bv, sn.into(), "SN -> BV conversion incorrect");
        assert_eq!(sn, bv.into(), "BV -> SN conversion incorrect");
        ...
        let bv =
            clash_macros::bitvector!(0xab_cd_ef_01_23_45_67_89_ab_cd_ef_01_23_45_67_89, n = 128);
        let sn = clash_macros::signed!(0xab_cd_ef_01_23_45_67_89_ab_cd_ef_01_23_45_67_89, n = 128);
        assert_eq!(bv, sn.into(), "SN -> BV conversion incorrect");
        assert_eq!(sn, bv.into(), "BV -> SN conversion incorrect");
    }
    ...
    fn bv_sn_conv_nonprim() {
        ...
        let bv = clash_macros::bitvector!(0x2b_cd_ef, n = 24);
        let sn = clash_macros::signed!(0x2b_cd_ef, n = 24);
        assert_eq!(bv, sn.into(), "SN -> BV conversion incorrect");
        assert_eq!(sn, bv.into(), "BV -> SN conversion incorrect");

        // Check for n = 25 (non-primitive-sized, sign extension needed)
        let bv = clash_macros::bitvector!(0x1_ab_cd_ef, n = 25);
        let sn = clash_macros::signed!(0x1_ab_cd_ef, n = 25);
        assert_eq!(bv, sn.into(), "SN -> BV conversion incorrect");
        assert_eq!(sn, bv.into(), "BV -> SN conversion incorrect");
    }
}
